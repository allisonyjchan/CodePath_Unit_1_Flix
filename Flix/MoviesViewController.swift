...
//  Flix
//
//  Created by Allison Chan on 9/19/21.
//
...
class MoviesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    // making an array [] of dictionaries [data type of key: data type of data]
    // The () refers to the creation of a new empty object?
    ...
    // When you leave the current screen, this function does some cleanup/prep work
    // before it happens
